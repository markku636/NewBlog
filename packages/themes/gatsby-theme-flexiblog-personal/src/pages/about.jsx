            ...
            <Box sx={styles.column}>
              <Section title='My Story'>
                <Card variant='paper'>
                  <Text variant='p'>
                    Hi, I’m Mark.Ku.
                    擁有超過 10 年經驗的軟體解決方案架構師，具備深厚的 Infrastructure 底層架構 基因，能從底層運維向上構建高可用的軟體系統。專精於大規模分佈式系統設計，成功主導過電子商務、高併發直播系統及複雜 POS 系統的開發。擅長整合 AI 應用、第三方金流與 SEO 策略，透過精準的技術選型與架構規劃，平衡技術卓越性與商業落地需求。曾多次帶領跨職能開發團隊，在大型敏捷團隊協作與小團隊敏捷開發中皆有豐富實戰經驗。
                  </Text>
                </Card>
