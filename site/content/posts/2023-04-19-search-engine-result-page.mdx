...
## 我們可以透過工具，快速 Google schema 埋到你的網站中
[工具連結](https://technicalseo.com/tools/schema-markup-generator/)

## 最後，我們可以透過 Google 的工具驗證
[工具連結](https://developers.google.com/search/docs/appearance/structured-data)

## 參考資料
[Google Search Central](https://developers.google.com/search/docs/appearance/structured-data/product#microdata_1)
