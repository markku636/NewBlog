---
featured: true
title: 使用 Langchain 和開源 Llama AI 在 Next.js 打造 AI Bot API Part 2: 開發具備記憶功能的 AI Agent
date:  2024-10-13 01:01:35 +0800
thumbnail:  langchain.jpg
category:  AI  
tags:   ['llama','ai','langchain' ]
description : 使用 Langchain 和開源 Llama AI 在 Next.js 打造 AI Bot API Part 2: 開發具備記憶功能的 AI Agent
author : Mark Ku
...
這篇談到大型語言模型，本身是不具備記憶功能，之所謂能讀懂上下文的問題，因為每次將討論的過程，再傳遞給大型語言模型，再去詢問。
