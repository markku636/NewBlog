...
## 購物方式
ShopMyExchange.com用戶有兩種購買商方式
* 1. 我們上架到他們網站
* 2. 是是建立我們的AAFES 網站瀏覽商品

## 目標
提供軍方授權客戶在 [ShopMyExchange 網站購物](https://www.shopmyexchange.com/)，當點擊 "Specialty Store :XXX"時，導頁至我們的 AAFES 網站，提供更多的商品資訊，結帳時導回去ShopMyExchange 付款，最後使用者在ShopMyExchange完成付款後會上傳指定FTP，我方在用排程下載FTP資料產生訂單。
