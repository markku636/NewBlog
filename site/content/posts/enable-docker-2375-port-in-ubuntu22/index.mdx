---
featured: true
title: Ubuntu 22 ，安裝Docker 及開啟遠端訪問佈署 2375 連接埠 22 ，安裝Docker 及開啟遠端訪問佈署 2375 連接埠
date:  2024-11-10 01:01:35 +0800
thumbnail:  ubuntu-with-2375.png
category:  DevOps  
tags:   ['Ubuntu','Docker','remote access' ]
description : Ubuntu 22 ，安裝Docker 及開啟遠端訪問佈署 2375 連接埠
author : Mark Ku
...
## 環境說明
因為越來越多雲端服務都是採用 Linux 伺服器，且因為Linux 輕載穩定的特性，不需要特別高規格的電腦，因此將舊電腦，Intel 8700 + 1060 顯卡整理成做為實驗機，並在上面安裝了 Ubuntu 22.04.5 LTS，做為研究一些雲平台使用，為了方便管理，我裝了 Ubuntu Desktop ，並自己架了 Rust Destktop ，方便連線進去維護。
...
```
## 接著依序[參考官方文件](https://docs.docker.com/desktop/setup/install/linux/ubuntu/)，就能在ubuntu 安裝 docker desktop 
