...
## 時空背景
近期，我們因 Bootstrap CSS 框架太肥大，導致 Google Lighthouse 每頁平均下降 5-10 分，因此我們計劃移除 Bootstrap。  

但因為頁面太多了，如果將每頁的網格佈局，重構成 Tailwind Grid 的排版方式，可能需要耗費相當多的時間，也提昇改壞的風險也提高，因此重構頁面部份，拆到下個階段執行。
...
## 撰寫一個 Powershell 腳本，檔案名為 convert-boostrap-to-tailwindcss.ps1，用於批量修改 Bootstrap CSS Class 
```
# 設定搜尋的目錄路徑
