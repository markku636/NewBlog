...
---
## 時空背景
目前公司內大部的系統都能夠容器化，但總有些舊網站，最舊也最大也最重錢，暫時無法做技術昇級，但人數一多手動佈版，都會遇到有人漏Commit binary，因此想把自動建置的部份自動化，減化佈版流程也減少錯誤帶來的影響。  

因為是舊系統及Net Mvc framework 的舊框架，無法容器化，全自動佈版，會有點風險，因此這邊佈署的部份，仍然還是採用手動。

## 目標
* 當有人 Push 任何code 到 Master 分支時，Jenkins 就會自動建置，並將建置完的 Binary ，自動commit 推送到 Github。
