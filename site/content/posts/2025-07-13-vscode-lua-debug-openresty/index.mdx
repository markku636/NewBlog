...
description: 教你如何在 VSCode 下針對 Lua 進行斷點除錯，並介紹必裝套件與常見排查技巧，OpenResty 實戰流程完整公開。
author: Mark Ku
---
...
- [Lua Debug](https://marketplace.visualstudio.com/items?itemName=actboy168.lua-debug)：支援多種 Lua 除錯協議
