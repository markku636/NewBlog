...
在大型的軟體開發中，維持一致的程式碼風格與高品質至關重要，本篇文章將介紹目前常見的Visual studio程式碼品質管理方法，並透過開發規範讓 AI 輔助開發，到最終程式碼審查，幫助團隊輕鬆維護高品質程式碼。
...
### 補充說明，也透過命令列 (CLI 去執行驗證規則，方便整合在CICD上)
...
在新的visual studio 在工具>選項 > Github Copilot 預設會啟用參考 github/copilot-instructions 指引做生成
