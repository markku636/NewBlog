...
## 此次採用的技術架構是
* 前端(電商網站) - (Next.JS、Eslint、Pritter、React) - [程式碼](https://github.com/markku636/oauth.nextjs)
* 後端(OAuth 服務) -( Nest JS + Mysql + Prisma + Swagger + class-validator做資料驗證) - [程式碼](https://github.com/markku636/oauth.nest.api)

## Demo 
* ![EC](https://oauth-nextjs.letgo.com.tw)
* ![Auth Service](https://oauth-nestjs-api.letgo.com.tw)
