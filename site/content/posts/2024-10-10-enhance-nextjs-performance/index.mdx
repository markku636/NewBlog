...
---
## 前言
用了兩年多 Next.JS 框架，本身針對建構或圖像本身就做了最佳化，就順手整理了一下，Next js 我們做了那些優化。

### 1.圖片最佳化
* Next.JS 的 Image，本身就做了很多的圖片優化，如: 懶加載、透過 Image loader 最佳化圖片(縮圖、格式轉換、品質壓縮)、並依據使用者的解析度給予不同的圖片尺寸，正確 Next.JS 的 Image 元件載入圖片，就可以輕易達到圖片的最佳化。
