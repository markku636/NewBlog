...
### 之後回到向量資料庫qdrant的 Dashboard > 點選 Visuallize
```
http://localhost:6333/dashboard
```
![Qdrant Dashbaord ](qdrant-dashbaord-1.png)

### 超酷的，點選Run，之後，就能看見向量資料庫所裡資料，像資料宇宙般程現
![Data universe](qdrant-dashbaord-2.png)

### 當你點選 OPEN GRAPH，就能展開被選取資料的關係圖，並將滑鼠滑動到連接的線上，就能得知，資料與資料間的相似度
![Graph](qdrant-dashbaord-3.png)

P.S. 有趣的是水餃和動物相似度居然有 0.8，和HP筆電的相似度是0.06，不知道是不是因為水餃是用動物做的嗎? XD 

## 因此我們得知，真實的水餃和動物不相關，因此，必須微調
