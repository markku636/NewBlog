...
## 總結
技術事後在回顧都會覺得很容易，但當下要查出關鍵原因，準時上線，都不是這麼容易事，光這麼多Ifra 問題，要如期上線，我自己就加班兩週以上，最終，歷經了各種困難，終於德國間在7/1 上線，在這些挑戰中學到，使用 Windows Server 環境時，應保持系統及其組件更新至最新版，以避免類似的技術問題。
