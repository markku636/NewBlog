---
featured: true
title:  導入高效全文檢索工具 Elasticsearch，改善電商網站搜尋體驗 - Part's 1
date:   2024-01-21 01:01:35 +0800
thumbnail:  enhancing-the-search-experience.jpg
category:  ECommerce
tags:   ['enhancing the search experience']
description : 導入高效全文檢索工具 Elasticsearch，改善電商網站搜尋體驗 - Part's 1
author : Mark Ku
slug: enhancing-the-search-experience
---
## 時空背景
客服經理和反饋，我們網站的搜尋功能體驗非常的差，用戶反應常常搜尋不到的規格，然後他說希望能像 Google 一樣搜尋體驗，因此我就花了些時間了解後，發現全文檢索應該是能解決我們的問題。
...
因為全文檢索技術和資料庫最大的差別就是，當資料量越大時，要對全表掃描時，對資料庫要耗費相當長的時間，但全文檢索技術採用[倒排索引](https://www.zhihu.com/question/23202010)的檢索技術，以依據各種分詞器將資料以 key 及 value 的形式儲存，查詢時就會變得簡單及快速。
...
### 資料庫則需要先定表結構，才能新增資料，但ElasticSearch 相當強大，先新增資料，自動推斷欄位型態
#### 單筆新增資料
```
