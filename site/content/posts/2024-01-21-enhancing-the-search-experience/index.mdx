...
---
## 時空背景
客服經理和反饋，我們網站的搜尋功能體驗非常的差，用戶反應常常搜尋不到的規格，然後他說希望能像 Google 一樣搜尋體驗，而且可以搜尋到SKU，因此我就花了些時間了解後，發現全文檢索應該是能解決我們的問題。
...
### 資料庫則需要先定表結構，才能新增資料，但ElasticSearch 相當強大，先新增資料，會自動推斷欄位型態。
#### 單筆新增資料
```
...
```
P.S 資料庫則需要先定表結構，才能新增資料，但ElasticSearch 相當強大，先新增資料，會自動推斷欄位型態。
###  查詢該筆id=1的資料
```
