...
### 編輯介面:界面很像 hackmd ，但支援多種 editor ，甚至可以插入流程圖，點擊兩下可就可以直接編輯，但儲存要在右上角按 save。
...
### 流量與熱區分析:Wiki.JS 兼容並支援多種流量分析工具，例如 hotjar，助您深入了解用戶行為。
![](12.png)

### 多語言支援與後台功能:Wiki.JS 支援多國語言，並提供一系列強大的後台管理功能。
![](13.png)
