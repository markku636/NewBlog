...
---
## 事件
2023年的美國時間黑色星期五，一早被 Call 了起來，運營在網站折扣給到 400~650美金，瞬間湧進大量的人，每秒都有人下單，訂單量是平常的XX倍以上，網站加載頁面後後無法正確在redis 拿到即時庫存，導致畫面卡死在加載從 redis 拉取庫存的loading 按鈕上，造成了用戶正確加入購物車。
![image](2.png)
