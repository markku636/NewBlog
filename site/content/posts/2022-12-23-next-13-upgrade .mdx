...
></Image>
```
P.S. 但因 NEXT JS 13 移除 Image 的 layout，我們很多頁面，目前用了會跑版，所以仍用舊的next image (next/legacy/image)，逐步去昇級，如果有新寫程式，或改到舊的，請逐步改成新的 next/image。 [新版 image 範例](https://github.com/vercel/next.js/tree/canary/examples/image-component/pages)
```
