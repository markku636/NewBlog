...
### SQL Server 版本過舊
我們發現 SQL Server 2016 使用過時的 TLS 1.0，新應用程式無法通過 TLS 驗證。為解決此問題，我們迅速升級至 SQL Server 2017，導致部署時間延長三小時。
