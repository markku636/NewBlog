...
* [可以透過一些程式的演算或方法，來消化瞬間載的效能瓶頸，融斷、隔離、重試、降級、超時、限流(令牌桶、等候室、漏桶)](https://blog.csdn.net/github_38592071/article/details/140196235)
...
* 採用現代化運維架構(K8s)，可以依據 request 或資源擴容及縮容。
