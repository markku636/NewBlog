...
## 運維
* 負載平衡器 - 負載平衡的原理，主要就是透過反向代理機制，可以讓多台服務器來分攤流量及任務。 (QPS < 10k，沒有預算可以用軟體的反向代理 nginx、yarp、但 QPS > 10k, 就得考慮買硬體的負載平衡[F5](https://www.f5.com/glossary/load-balancer))
* 採用現代化系統運維架構(K8s)，可以依據 QPS 或系統資源擴容及縮容。
* 服務監控 (Healthy Check)。 如: [Uptime-kuma](https://blog.markkulab.net/2021/12/11/application-monitor-uptime-kuma/)
* 可觀測性。 如: [signoz](https://www.cnblogs.com/hacker-linner/p/17581720.html)
* 日誌服務器Log Server。如: grafana、seq
