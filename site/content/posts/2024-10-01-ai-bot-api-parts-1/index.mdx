---
featured: true
title: 透過 Langchain 及開源 llama AI 在Next JS 打造自己的AI Bot API part's 1 - 從了解 lanchain 開始
date:  2024-10-01 01:01:35 +0800
thumbnail:  langchain.jpg
category:  AI  
tags:   ['llama','ai','langchain' ]
description : 透過 Langchain 及 開源 llama AI 在Next JS 打造自己的AI Bot API part's 1 - 從了解 lanchain 開始
author : Mark Ku
