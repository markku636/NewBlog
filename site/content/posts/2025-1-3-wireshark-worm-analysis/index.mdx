...
---
## 時空背景
前情提要，在將[windows 開發機轉Linux時發現公司電腦好像有人中了蠕蟲](https://blog.markkulab.net/migrate-windows-to-linux-development-environment/)，Docker 跑出未知得的容器服務，網路分享資料夾(Samba)也發現不明exe ，猜測辦公室的的電腦可能中毒蠕蟲，同事用Wireshark 找到惡意的機器，就順便和他學了一下 Wireshark。
