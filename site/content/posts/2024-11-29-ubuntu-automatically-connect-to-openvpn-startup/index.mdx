---
featured: true
title: Ubuntu automatically connects to Open VPN on startup
...
description: Ubuntu automatically connects to Open VPN on startup
author: Mark Ku
...
## Create up vpn account and password file for open vpn
