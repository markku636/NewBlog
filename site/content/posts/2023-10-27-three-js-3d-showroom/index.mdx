---
featured: true
title:  React three fiber 3D 產品展示實作筆記
date:   2023-10-27 01:01:35 +0300
thumbnail: three-js.png
category: Frontend
tags:   ['Three.js','3d','3d-showroom','react','next js']
description : Resolve Three.js Video texture is not working in iOS 16 
author : Mark Ku
...
### vectary Oline tool 轉檔需付費，但可以試用幾天
https://www.vectary.com/dashboard/?workspaceId=718018e4-f18d-4318-9386-3a40019aea5a
為什麼選擇vectary？
有許多3D轉換工具可以選擇，但我選擇了vectary，因為它具有直觀的界面，並提供了簡單的導入和導出功能。此外，vectary還有豐富的教學資源，幫助我快速上手。透過這個工具，我可以輕鬆將soliwork檔案轉換為網頁支持的格式
### blender ( 開源 ) + stepper plugin (付費)
...
```
### 此時，我們己經拿到製作3d 產品展示所需要的檔案，接下來依據此篇 blog ，我們就可以做出我們的 3d 產品展示
![](1.png)
...
## 結論
![](2.png)
[Demo](https://3d.ibuypower.com/)

隨著技術的發展，3D網頁模型在線上展示和配置中的應用將會越來越廣泛，了解並掌握這些技術於開發者是至關重要的，畢竟，只有跟上時代的腳步，我們才能為客戶提供最好的使用體驗。
