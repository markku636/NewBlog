...
## 上傳自己的公鑰及取得相關秘鑰
### 首先，進入後台 > 選擇Sandbox View > [Integration central](https://sellercentral.amazon.de/gp/pyop/seller/integrationcentral?ref=py_intcentr_confcard_sboxhome_GB) 

![Find Integration central](find-integration-central.png)

### 因為我有兩個國家的帳號，對照後發現這邊有個bug，有個帳號會找不到上傳 public key的功能
...
### 接著依據官方文件[doc](https://developer.amazon.com/docs/amazon-pay-api-v2/manually-generating-key-pairs.html#generating-key-pair) , 產生 rsa 公鑰與私鑰
...
## 測試方式
* 因為Amazon pay需要導頁來導頁去，需要有https，也要有自己的domain，我這邊是透過Cloudfalre tunnel 當反向代理測試
