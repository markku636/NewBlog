...
## 挑戰與困難
原本招募我進來的目的是規劃及重新打造德國網站，但因為美國網站[一直有問題](https://blog.markkulab.net/nextjs-performance-issues-in-e-commerce/)及有更急的專案，也[重構了4000行的前端購物車程式](https://blog.markkulab.net/react-refactor-shopping-cart/)，

在經歷了充滿挑戰的第一年半，美國網站的趨近於穩定。
