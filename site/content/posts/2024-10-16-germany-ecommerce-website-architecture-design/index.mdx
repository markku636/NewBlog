...
當時的時空背景下，App routing 剛stable ，因此，

### 導入了Headless CMS [Strapi](https://blog.markkulab.net/headless-cms-strapi/)
...
### 多語系
多語系原本是放在strapi ，因為發現在開發階段，覺得使用者在Strapi新增多語系很繁瑣，後來全部將其維護功能，移到 Office 365 使用者可以更輕鬆一次維護多個語系。
...
## 結論
真的很不容易，最終德國網站終於順上線，也不是我一個人能做到，過程中感謝很多人的幫助，在這過程我也學到很多。
