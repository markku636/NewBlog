...
## 結論
德國專案其實並不是從2月中才開始的，早在我剛加入公司時，只要有空閒，我就開始偷偷研究架構規劃，從舊有的程式碼中推導出需求，並思考如何縮短開發時間。儘管開發過程中遇到不少小插曲，但最終我們在7月1號成功上線，德國網站如期順利運行，歐洲市場也逐步進入正軌。這次的成功不只是個人的努力，過程中也獲得了許多人的幫助。由於沒有專職PM，設計主管和技術主管兼任這個角色，加上資源有限，我們在一邊規劃、一邊開發的同時，還需要協調外部事務，能夠達成這個目標，確實不容易。
