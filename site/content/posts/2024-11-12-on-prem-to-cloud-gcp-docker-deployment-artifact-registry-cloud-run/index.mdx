...
---
### 前言
本身對於自架伺服器特別有興趣，而我過去的經驗，大多都在地端，從自架Windows Server 到Linux Server 到，Windows Contianer 到 Linux Container，但隨著容器技術的發展和雲端的便利性提升，也越來越多大型企業採用雲端的伺服器，讓我好奇進一步探索雲端部署的可能性。
