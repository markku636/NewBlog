...
---
### 前言
過去我對自架伺服器特別有興趣，多數經驗集中在地端環境，從自架 Windows Server 和 Linux Server，到使用 Hyper-V 和 vSphere，並從 Windows Container 到 Linux Container 等技術都有涉略，隨著容器技術的發展和雲端便利性的提升，越來越多企業採用雲端伺服器，激起了我進一步探索雲端部署可能性的興趣。
