...
At the first stage, I could only use simple single words to answer.
從一開始只能用單字拼湊回答，  
...
In the next stage, I could directly express ideas use multiple sentences with English thinking or another way describe answer, but I often lost grammar and conjunctions.  
