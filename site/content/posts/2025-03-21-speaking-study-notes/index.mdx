...
1. **Point（重點）**:  
   ...
   ✅ *For example: "The best way to stay healthy is to exercise regularly."*  
   *(例如：「保持健康最好的方法就是規律運動。」)*  
...
2. **Consider（思考）**:  
   ...
   ✅ *Why is this important? What problems could it solve?*  
   *(為什麼這個很重要？它能解決什麼問題？)*  
...
3. **Reason（理由）**:  
   ...
   ✅ *"Regular exercise helps improve cardiovascular health and boosts mental well-being."*  
   *(「規律運動有助於提升心血管健康，還能改善心理狀態。」)*  

4. **Example（例子）**:  
   - Provide a specific, relatable example to support your idea.  
   - **舉具體、生活化的例子來支撐你的觀點，讓回答更有說服力。**  

   ✅ *"For instance, my friend started jogging three times a week, and now she feels more energetic and sleeps better."*  
   *(「比如，我朋友開始每週跑步三次，現在感覺更有活力、睡得也更好。」)*  

5. **Conjunctions（連接詞）**:  
   - Use appropriate conjunctions to make your sentences flow smoothly and sound more natural.  
   - **使用適當的連接詞，讓句子更順暢、更自然。**  

   ✅ *"In addition, besides that, on the other hand, therefore, however, for example…"*  
   *(「此外、除了這個、另一方面、因此、然而、例如……」)*  
