...
## 前言
During my journey of learning English speaking, I went through several noticeable stages.  
在學習英文口說的過程中，我經歷了幾個明顯的階段。  

At first, I could only respond using single words,  
從一開始只能用單字拼湊回答，  

Then, I gradually improved, thinking in Chinese and translating into English while speaking.
接著慢慢進步到腦中用中文思考邊翻譯邊回答。  

Next came a more intuitive stage,
接著很明顯的進入下個階段，  

I could express ideas using multiple sentences,  
雖然回答變得比較直覺，只能用很多句子很直覺地去表達一件事，  

but I often overlooked grammar and conjunctions.  
但也常常顧不上文法及連接詞。  

After studying at a language school for a while, I realized my speaking progress had plateaued.  
到了語言學校一陣子後，發現口說的進步停滯不前，  

So, my teacher and I adjusted my learning approach.  
於是我和老師調整了學習方式，  
...
### Look at the Picture and Describe（看圖故事）  
