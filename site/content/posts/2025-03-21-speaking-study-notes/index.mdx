...
In my experience, I worked for the e-commerce company, we sold the high performing gaming computer in the U.S.
the company's working speed is quick, and we had to respond requirement immediately. we always follow the trend.
so I learn the something is efficient. 
...
during the black firday, our website get a lot of request from the hackers
and we also scribe cloudflare service, but default setting is not enought. 
I define the prevent policy to avoid the attack.
I have talent in making my work efficient such as writing automatic script for software development.
and deal with people.
Finally I very confident that I really qualified the job. I believe I can bring value into your team and help the team work be better.
