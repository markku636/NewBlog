...
the company's working speed is quick, and we had to respond requirement immediately. we always fllow the trend.
so I learn the something is efficient. 
For example, When AI came, I used (utilized) to search engine optimization and  try to build AI recommendation
I have 10 years experience in software development. Before, I dealt with so many tricky problems, and
I have talent in the make work efficient and preventing website attack and deal with people.
