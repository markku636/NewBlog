...
Then, I improved, I could translate into English from Chinese thought while speaking.   
...
## What's (top / difficult) problem did you resolve in your experience  ?
I think the most difficult is not the technical problem, sometimes the most difficult problem is dealing with people. 
everyone came to company who have different expectation.
For example, I usually had a 1 on 1 meeting with my team member, I had one who wanted working from home. 
I tried to negotiate with my boss, if she can prove her performance much better, could you give her once a week.
Moreover another team member , he wanted to get more challenging work , I told the project manager , then assignment project for him,

In addition, I deal the conflict with end users, 
end user's different expectation and delivery day in project priority, 
,then I should drill down the detail, estimate the working hour and communicate with them clearly.

## Why should I hire you ?
I have 10 years experience in software development. 
Until now I keep my passion with software and keep up with the latest trends

Before I worked for an e-commerce company. We sold high-performing gaming computers in the U.S. 
the company's working speed is quick, and we had to respond to requirements immediately. we always follow the trend. 
so I learn that something is efficient.  

For example, When AI came, I used (utilized) AI to search engine optimization and  try to build AI recommendation

Moreover, I dealt with so many tricky problems,such as   
During the black Friday, our website get a lot of requests from hackers   
and we also subscribed Cloudflare service, but the default setting was not enough.  
I define the prevention policy to avoid the attack.
we successfully protected our website during holiday season.
    
In addition,I have talent in making my work efficient such as writing automatic scripts for software development. 
and deal with people.  

Finally I am very confident that I am really qualified for the job. Base on my experience, I believe I can bring value to your team and help the teamwork to be better. 
...
Then, the front desk announced that a child was missing.
