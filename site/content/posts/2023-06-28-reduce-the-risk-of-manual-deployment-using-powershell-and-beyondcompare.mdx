...
Firstly, all deployment DLLs must be committed to USApiArtifact, which can be accessed by navigating to the Publish folder at https://github.com/iBuypowerUS/USApiArtifact.

Next, connect remotely to 192.168.20.150 and right-click deploy-us-api.ps1 on the desktop and select "Run with PowerShell". This will pull down the latest DLLs.
