---
featured: true
title: Ubuntu 上的 Kubernetes 安裝與配置教學
date:  2024-11-11 01:01:35 +0800
thumbnail:  ubuntu-with-kubernetes.png
category:  DevOps  
tags:   ['Ubuntu','Docker','Kubernetes' ]
description : Ubuntu 上的 Kubernetes 安裝與配置教學
author : Mark Ku
slug: intsll-kubernetes-in-ubuntu
---
## 前言
先前[研究用了 windows 安裝了 Kubernetes](https://blog.markkulab.net/jenkins-deploy-kubernetes-with-docker-for-windows/) , 但因為Windows docker 不是這麼穩定又耗能，因此，研究了一下主流大家在用Linux 版的Kubernetes。
...
```
  ...
  # etcd 集群通訊
  ufw allow 2379/tcp   # etcd client communication
  ufw allow 2380/tcp   # etcd server-to-server communication

  # kubelet API
  ufw allow 10250/tcp  # Kubelet API
  ufw allow 10255/tcp  # Read-only Kubelet API (可選)
  ufw allow 10248
