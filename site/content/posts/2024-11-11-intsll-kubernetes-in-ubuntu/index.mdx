...
---
## 前言
先前在[Windows Docker Desktop 安裝了 Kubernetes](https://blog.markkulab.net/jenkins-deploy-kubernetes-with-docker-for-windows/) , 但因為Windows K8S 只能有單節點，且不是這麼穩定又耗效能，因此，在家搭建一套主流大家在用Linux 版的Kubernetes。
