---
featured: true
title: http post FromBody string parameters always binding null in Dotnet
date:  2022-11-06 01:01:01 +0800
thumbnail: question-mark.jpg
category: NETCORE
tags: ['dotnet','bind','always','null']
description : http post FromBody string parameters always binding null in Dotnet
author : Mark Ku
...
```
[HttpPost]
public string Book([FromBody] string test) // bindding string always is null 
{
return test;
}
```
