...
### 雖然我們的 Cloudflare是企業版的，看起來靠預設的設定，還是無法抵抗 Ddos，然後我花了很多時間學習 Cloudflare，查看 Cloudflalre 所有設置，並和我的老闆討論，接著我制定了一個防止Ddos的計劃，建議使用 Web 應用程序防火牆規則以在黑色星期五期間保護我們的生意，並取我們得美國老闆的許可。規則如下:
