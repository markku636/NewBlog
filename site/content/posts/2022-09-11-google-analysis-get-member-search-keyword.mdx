---
featured: true
title: 透過 GTM 將使用者行為整合至 GA4 - 取得平台在電子商務網站搜尋了什麼 - Part's 2
...
description : 透過 GTM 將使用者行為整合至 GA4 - 取得平台用戶在電子商務網站搜尋了什麼 - Part's 2
author : Mark Ku
slug: ga4-get-member-search-keyword
---
## 目的
希望透過 Google analysis 報表，了解會員平時在經營的電子商務搜尋了些什麼關鍵字。
...
## 填寫 Data Layer Variable Name ，可以透過 Chrome's Datalayer Checker Plugin，取得Variable Name，並將變數名字改成方便識別的名稱 "DataLayer - searchString"。
![](https://i.imgur.com/ltZq6n8.png)
(Chrome's Datalayer Checker Plugin > Copy Key)
