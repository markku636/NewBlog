---
featured: true
title: 使用 Langchain 和開源 Llama AI 在 Next.js 打造 AI Bot API Part 3 - 加入向量資料庫，讓AI擁有有相似度查詢的功能
date:  2024-10-15 01:20:35 +0800
thumbnail:  langchain.jpg
category:  AI  
tags:   ['llama','ai','langchain' ]
description : 使用 Langchain 和開源 Llama AI 在 Next.js 打造 AI Bot API Part 3 - 加入向量資料庫，讓AI擁有有相似度查詢的功能
author : Mark Ku
